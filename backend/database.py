...
SLUVO_AGENT_WORKFLOW_TABLE_STATEMENTS = [
...
def ensure_sluvo_agent_workflow_tables() -> None:
    with engine.connect() as conn:
        for sql in SLUVO_AGENT_WORKFLOW_TABLE_STATEMENTS:
            try:
...
def _ensure_lightweight_columns() -> None:
    statements = [
        ...
        *SLUVO_AGENT_WORKFLOW_TABLE_STATEMENTS[:3],
